package br.gov.mt.tce.doc.pdf;

import br.gov.mt.tce.doc.entity.Materia;
import br.gov.mt.tce.doc.enumerados.LarguraPaginaEnum;
import br.gov.mt.tce.doc.pdf.config.LayoutConfig;
import br.gov.mt.tce.doc.pdf.customrenderer.ColumnRendererAlternateArea;
import br.gov.mt.tce.doc.pdf.event.MoveContentEndPageEventHandler;
import br.gov.mt.tce.doc.pdf.htmlcustom.TagAppender;
import br.gov.mt.tce.doc.pdf.service.PrinterContent;
import br.gov.mt.tce.doc.service.MateriaService;
...
/**
 * Classe utilizada para geração do arquivo PDF com capacidade de
 * modificação do sentido da impressão
 */
public class GeneratePDFAlternateArea {
    ...
    public static void main(String args[]) throws Exception {
        new GeneratePDFAlternateArea().executeWithMaterias();
    }
    ...
    public void executeWithMaterias() throws IOException {
        List<Materia> allMaterias = new MateriaService().buildMateriaList(10  , 2);
