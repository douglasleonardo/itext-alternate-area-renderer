package br.gov.mt.tce.pdftest.customcomponent;
...
@Deprecated
public class CustomColumnRenderer extends DocumentRenderer {
    ...
    public CustomColumnRenderer(Document document, Rectangle[] columns) {
        super(document, true);
